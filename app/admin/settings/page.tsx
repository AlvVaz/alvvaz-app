...
const NOTICE_COPY: Record<string, string> = {
  admin_created: "Administrador agregado.",
  profile_updated: "Perfil actualizado.",
};

const ERROR_COPY: Record<string, string> = {
  not_owner: "Solo el owner puede agregar admins.",
...
export default async function AdminSettingsPage({
  ...
  const notice = searchParams?.notice ? NOTICE_COPY[searchParams.notice] : "";
      ...
      <div className="grid gap-6 lg:grid-cols-[1.2fr_1fr]">
        <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <div className="mt-8 border-t border-slate-200 pt-6">
            ...
            <p className="mt-2 text-sm text-slate-600">
              Lista de accesos actuales. (Los enlaces de invitación los
        ...
        <section className="space-y-6">
          ...
          <AddAdminCard isOwner={isOwner} action={createAdmin} />
